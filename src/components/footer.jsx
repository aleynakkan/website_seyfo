      ...
      <div className={styles.grid}>
        ...
        <div className={styles.column}>
          ...
          <div className={styles.socialLinks}>
            <a href="#" className={styles.socialIcon}><img src={imgVector} alt="" /></a>
            <a href="#" className={styles.socialIcon}><img src={imgVector1} alt="" /></a>
            <a href="#" className={styles.socialIcon}><img src={imgVector4} alt="" /></a>
            <a href="#" className={styles.socialIcon}><img src={imgVector6} alt="" /></a>
          </div>
        </div>
      </div>
